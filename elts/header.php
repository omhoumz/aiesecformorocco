<header class="header header-section">
	<div class="inner-header">
		...
		<!-- Modal -->
		<div class="modal fade" id="MCModel" tabindex="-1" role="dialog" aria-labelledby="MCModelTitle" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLongTitle">Check out opportunities in:</h5>
